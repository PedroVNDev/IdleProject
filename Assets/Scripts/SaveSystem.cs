...
public class SimpleAES
{
    ...
    private const string initVector = "<wtpkss4tjhfye7ty>";
...
public class SaveSystem : MonoBehaviour
{
    ...
    protected static string encryptKey = "<l1hprrl4frbns82pasf3c70k>";
    protected static string savePath = "/IdleImpact.save";
    protected static string savePathBackUP = "/IdleImpactBackup.save";
    ...
    public static void LoadPlayer(ref PlayerData data)
    {
        ...
        {
            // Try to load main
            LoadSaveFile(ref data,
                Application.persistentDataPath + savePathBackUP); // Load backup if main failed to load
        }
    }
